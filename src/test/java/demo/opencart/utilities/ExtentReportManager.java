...
public class ExtentReportManager extends TestListenerAdapter {
	...
	public void onStart(ITestContext testContext) {
		if (htmlReporter == null) {
			...
			htmlReporter.config().setDocumentTitle("opencart Web App Register Account & Login By Mustapha");
			htmlReporter.config().setReportName("opencart Register Account & Login Report");
